...
<script>
import PreviewInPhone from '@/smart/components/ContentCenter/PreviewInPhone'
import { getTree } from '@/smart/api/material'
import { lexicalAdd, lexicalDetail } from '@/smart/api/contentCenter/scriptCenter'
import { templateAdd, templateDetail } from '@/smart/api/contentCenter/modleCenter'
import DragTable from '@/smart/components/DragTable'
import MaterialCenter from '@/smart/components/ContentCenter/MaterialCenter'
import { string } from 'clipboard'
import { getPosterInfo } from '@/smart/api/material/poster'
import { getDetail } from '@/smart/api/material/index'
import TemplateLibrary from '@/smart/components/ContentCenter/TemplateLibrary'
import MessageContentForm from '@/smart/components/MessageContentForm'
export default {
  name: 'add-material',
  components: {
    PreviewInPhone,
