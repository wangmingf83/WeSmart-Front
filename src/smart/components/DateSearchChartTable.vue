...
<script>
// import * as customerApi from '@/smart/api/operateCenter/customerAnalysis'
// import * as groupApi from '@/smart/api/operateCenter/groupAnalysis'
// import * as conversationApi from '@/smart/api/operateCenter/conversationAnalysis'
import { getList as getGroupList } from '@/smart/api/customer/group'
export default {
  name: '',
  components: {
    ChartLine: defineAsyncComponent(() => import('@/smart/components/ChartLine')),
    ChartBar: defineAsyncComponent(() => import('@/smart/components/ChartBar')),
  },
  props: {
    // 数据展示图表类型
    type: {
