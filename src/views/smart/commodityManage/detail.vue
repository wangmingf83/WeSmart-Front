<script>
import TimeSearchTitle from '@/smart/components/common/TimeSearchTitle'
import ChartLine from '@/smart/components/ChartLine.vue'
import * as api from '@/smart/api/commodityCenter/commodityManage'
export default {
  name: '',
    ...
    <el-row :gutter="10" type="flex">
      <el-col :span="18">
        ...
        <div class="g-card">
          ...
          <time-search-title @search="getLineData" />
          <chart-line style="height: 300px" :legend="legend" :xData="xData" :series="series" />
        </div>
        <div class="g-card">
          <div class="g-card-title">员工订单Top5</div>
          <el-table v-loading="loading" :data="list" style="width: 100%">
            <el-table-column label="员工" align="center" min-width="100" prop="weUserName" />
            <el-table-column label="订单总数" align="center" prop="orderNum" min-width="100" />
            <el-table-column
              label="订单总额（元）"
              align="center"
              prop="totalFee"
