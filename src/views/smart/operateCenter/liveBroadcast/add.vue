...
import { addOrUpdate, detailLive } from '@/smart/api/operateCenter/liveBroadcast'
import * as api from '@/smart/api/enterpriseId'
export default {
  components: {
    AddMaterial,
    PreviewInPhone,
  ...
  data() {
    return {
      ...
      minEndTime: '',
      active: 0,
      liveUrl: 'http://demo.guitu.net/mobile/#/***', // 直播链接
      talkList: [],
      userInfo: '',
      groupInfo: '',
      customerInfo: '',
