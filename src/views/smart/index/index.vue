  ...
  <div class="index">
    ...
    <div class="index-r">
      <div class="content-right">
        <div class="g-card inedx-r-top" v-if="lwConfig.IS_guitu">
        ...
        <!-- 帮助中心 -->
        <div class="g-card help-center" v-if="lwConfig.IS_guitu">
          <div class="g-card-title fxbw">
            <span>帮助中心</span>
            <a
              class="title-right-icon"
              style="color: var(--font-white) !important; background: var(--bg-black)"
              href="https://www.yuque.com/guitu/help"
              target="_blank">
              ➔
            </a>
          </div>
          <a class="help-item" href="https://www.yuque.com/guitu/help/ozzxus" target="_blank">
            <div>
          ...
          <a class="help-item" href="https://www.yuque.com/guitu/help" target="_blank">
            <div>
          ...
          <a class="help-item" href="https://www.yuque.com/guitu/help/qk5gl6" target="_blank">
            <div>
...
<script>
import { getUserProfile } from '@/smart/api/system/user'
import * as api from '@/smart/api/index'
// import { getCustomerServiceQrUrl } from '@/smart/api/login'
      ...
      helpCenterList: [
        {
          ...
          title: '最新进展',
          url: 'https://www.yuque.com/guitu/help/ozzxus',
        },
        {
          icon: 'product-manual',
          title: '产品手册',
