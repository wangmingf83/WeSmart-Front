  ...
  <div class="chatListClassTab" v-loading="loading">
    ...
    <div class="list">
      <template v-if="list.length">
        <chatList :queryChat="queryChat" v-if="'all,image,video,link,'.includes(type)" :data="list"/>
          ...
          <el-table-column prop="address" min-width="80" label="操作">
            <template #default="{ row }">
              ...
              <!-- <AudioPlayer
                ...
                ref="AudioPlayer"
              /> -->
              <voice :amrUrl="JSON.parse(row.contact)['attachment']"/>
              <!-- <audio controls>
...
<script>
  ...
  import * as api from '@/smart/api/conversation/content.js'
  import Voice from '@/smart/components/Voice'
  import { download } from '@/smart/api/common.js'
  import { diffDate } from '@/smart/utils/index'
