<script>
import { dictJoinGroupType } from '@/smart/utils/dictionary'
import * as api from '@/smart/api/customer/group'
  ...
  <div v-loading="loading">
            ...
            <div class="info" style="flex: 1">
              ...
              <div style="display: inline-block">
                <template v-if="group.tags">
                  <TagEllipsis :list="group.tags" limit="8"/>
                </template>
              </div>
    ...
    <div class="g-card">
      <el-table :data="list" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="进群时间" prop="joinTime"/>
