<script>
import { getListTable } from '@/smart/api/customer/dimission'
  ...
  <div class="page">
    <el-form ref="queryForm" :inline="true" :model="query" label-width="" class="top-search">
      <el-form-item label="已离职员工" prop="userName">
        <el-input clearable v-model="query.userName" placeholder="请输入"/>
      </el-form-item>
    ...
    <div class="g-card">
      <el-table ref="multipleTable" :data="list" tooltip-effect="dark" style="width: 100%">
        ...
        <el-table-column prop="allocateCustomerNum" label="已分配客户数" show-overflow-tooltip/>
        <el-table-column prop="allocateGroupNum" label="已分配群聊数" show-overflow-tooltip/>
