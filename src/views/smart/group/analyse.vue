<template>
  <div>
    ...
    <div class="g-card">
      ...
      <search-title @search="getLineData"/>
...
import SearchTitle from '@/smart/components/SearchTitle.vue'

import { getLineChartTotal, getTableTotal, getGroupDetail } from '@/smart/api/drainageCode/group.js'
