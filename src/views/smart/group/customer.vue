<script>
import { getList } from '@/smart/api/customer/group'
  ...
  <div>
    <el-form ref="queryForm" :model="query" :inline="true" class="top-search" label-width="70px">
      <el-form-item label="群名" prop="groupName">
        <el-input clearable v-model="query.groupName" placeholder="请输入群名"/>
      </el-form-item>
      <el-form-item label="群主" prop="groupLeader">
        <el-input clearable v-model="query.groupLeader" placeholder="请输入群主"/>
      </el-form-item>
      ...
      <el-table
        ...
        <el-table-column width="55" align="center">
          <template #default="{ row }">
            <el-checkbox :value="currentRow && row.chatId === currentRow.chatId"/>
          </template>
        </el-table-column>
        <el-table-column prop="groupName" label="群名" align="center"/>
        <el-table-column prop="memberNum" label="群人数" align="center"/>
        <el-table-column prop="groupLeaderName" label="群主" align="center"/>
