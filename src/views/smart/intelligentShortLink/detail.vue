<script>
import { getDetail, getLineAnalysis, getAnalysis } from '@/smart/api/intelligentShortLink'
export default {
  name: '',
  components: {
    TimeSearchTitle: defineAsyncComponent(() => import('@/smart/components/common/TimeSearchTitle')),
