<template>
  <doc-tip title="对企业的朋友圈动态信息进行统一运营，可分配员工发表动态任务。" />
  <div>
    ...
    <div class="g-card">
      ...
      <el-table ref="table" v-loading="loading" :data="tableData">
        ...
        <el-table-column show-overflow-tooltip prop="createTime" width="170px" label="创建时间"/>
    ...
    <el-dialog title="详情" v-model="detailDialogVisible" width="40%">
      <el-form label-position="right" label-width="100px">
        ...
        <el-form-item label=" ">
          <div class="img_list">
            <div v-for="(data, index) in detail.otherContent" :key="index">
              <el-image
                class="item"
                style="width: 100px; height: 100px"
...
import { getEnterpriceList, syncHMoments, getDetail } from '@/smart/api/circle'
...
export default {
  ...
  methods: {
    gotoRoute() {
      this.$router.push({
        // path: lwConfig.lwCommon.INTERESTING_PUBLISH_ROUTE_NAME,
        path: './publish',
      })
    },
    setTimeChange(e) {
