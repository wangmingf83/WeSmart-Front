  ...
  <div class="content">
    ...
    <div style="display: flex; flex-wrap: wrap">
      <div class="item" v-for="(data, key) in list" :key="key">
        <!-- <div class="avatar222"><img src="../../../smart/assets/drainageCode/header.png" /></div> -->
          ...
          <div class="word-and-image">
            ...
            <div class="sub-content">
              ...
              <div>
                ...
                <svg-icon class="icon-style" icon="imgText" v-else/>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="msg" v-if="data.mediaType === '12'">
          <div class="word-and-image">
            ...
            <div class="sub-content">
              ...
              <div>
                <img :src="data.coverUrl" v-if="data.coverUrl && data.coverUrl != ''" />
                <svg-icon class="icon-style" icon="article" v-else/>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="msg" v-if="data.mediaType === '2'">
          <div class="word-and-image">
            ...
            <div class="sub-content">
              ...
              <div>
                <img :src="data.coverUrl" v-if="data.coverUrl && data.coverUrl != ''" />
                <svg-icon class="icon-style" icon="pic" v-else/>
              </div>
            </div>
          </div>
        </div>
...
.redBox {
  ...
  .red-box {
    width: 165px;
    height: 68px;
    background-image: url('../../../smart/assets/image/newred.png');
    background-size: 100%;
