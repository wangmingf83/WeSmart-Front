  ...
  <div>
    <div class="flex">
        ...
        <div class="g-card">
          ...
          <div>
            <el-table v-loading="customer.loading" :data="customer.list">
              ...
              <el-table-column label="送达时间" align="center" prop="sendTime" width="180"/>
      ...
      <div class="g-card" style="width: 425px; margin-top: 0">
        <PreviewInPhone :templateInfo="form.welcomeMsg" :originList="form.materialMsgList"/>
      </div>
    </div>
  </div>
</template>
...
<script>
import { getDetail, memberList, resultList, syncMsg } from '@/smart/api/groupMessage'
import PreviewInPhone from '@/smart/components/ContentCenter/PreviewInPhone.vue'
