...
<script>
import { getDetailRaw, add, getCustomerList } from '@/smart/api/groupMessage'
import { getMaterialMediaId } from '@/smart/api/material'
import { getList } from '@/smart/api/salesCenter/businessConver.js'

import SelectCustomerGroup from '@/smart/components/SelectCustomerGroup'
import moment from 'moment'
import { parseTime } from '@/smart/utils/common'
import AddMaterial from '@/smart/components/ContentCenter/AddMaterial'
import { delTreeKeys } from '@/smart/utils/index'
export default {
  components: {
    // SelectCustomerGroup,
    AddMaterial,
