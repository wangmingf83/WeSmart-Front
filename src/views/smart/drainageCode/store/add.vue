...
<script>
import BaiduMap from '@/smart/components/common/BaiduMap'
// import SelectStaffQrCode from '@/smart/components/SelectStaffQrCode'

import { getProCityList } from '@/smart/api/common'
import { addOrUpdateStore, storeDetail } from '@/smart/api/drainageCode/store'
export default {
  name: 'store-add',
  props: {
    isDetail: {
  ...
  components: {
    BaiduMap,
    // SelectStaffQrCode,
    FormAutoCreateGroup: defineAsyncComponent(() => import('@/smart/components/FormAutoCreateGroup.vue')),
  },
  data() {
    return {
      areaArray: [],
