...
import { getDetail, add, update, getCodeCategoryList } from '@/smart/api/drainageCode/staff'
//新增表单；表单列表查询
import {
  insertInfoToSurvey,
  selectInfoToSurvey,
  ...
  deleteInfoToSurvey,
  // uploadFile,
} from '@/smart/api/drainageCode/smartForms.js'
import FormsDetail from './build/formsDetail.vue'

import SelectMaterial from '@/smart/components/SelectMaterial'
