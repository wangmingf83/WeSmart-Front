  ...
  <div>
    <el-form ref="queryForm" :model="query" inline class="top-search" label-position="left" label-width="">
      <el-form-item label="" prop="customerName">
        <el-input clearable v-model="query.customerName" placeholder="请输入客户名称"/>
      </el-form-item>
      <el-form-item label="">
    ...
    <div class="g-card">
      ...
      <el-table :data="list" v-loading="loading">
        ...
        <el-table-column prop="chatName" label="所在客群" align="center"/>
        <el-table-column prop="sendUserName" label="发送员工" align="center"/>
    ...
    <SubDetailVue v-model:visible="detailVisible" :fissionInviterRecordId="detailId" fissionType="group"/>
    <select-group v-model:visible="showSelectModal" :defaults="groupList" @submit="setSelectData"/>
  </div>
</template>
...
import { dateFormat } from '@/smart/utils/index'
import SelectGroup from '@/views/smart/drainageCode/components/SelectGroup.vue'
