        ...
        <el-row :gutter="20" type="flex">
          <el-col>
              ...
              <FassionBase :baseData="form" :isDetail="true">
                <div>
                  <el-form-item label="任务状态" prop="fassionState">
                    <el-tag
                      :type="
                        form.fassionState == 1 ? 'info' : form.fassionState == 3 ? 'danger' : ''
                      "
                    >
                      {{ setStatus(form) }}
                    </el-tag>
            ...
            <div class="g-card">
              ...
              <FassionSettingVue :baseData="form" :isDetail="true" />
            </div>
            <div class="g-card">
              <div class="info_title">兑奖规则</div>
              <FassionRules :baseData="form" :isDetail="true" />
            </div>
          </el-col>
          <el-col style="flex-basis: 370px">
            <div class="g-card">
              <PreviewInPhone name="客群" :list="[news]" :templateInfo="form.content" />
            </div>
          </el-col>
        </el-row>
      </el-tab-pane>
      <el-tab-pane label="任务统计" name="second">
        <Statistics v-if="form.id" :fassionType="form.fassionType" />
      </el-tab-pane>
