<template>
  <div>
    ...
    <template v-if="currentActive == 0">
      <FassionBase :baseData="form" @update="getData" @next="getNext"/>
    </template>
    <template v-if="currentActive == 1">
      <FassionSettingVue :baseData="form" @update="getData" @next="getNext"/>
    </template>
    <template v-if="currentActive == 2">
      <FassionRules :baseData="form" @update="getData" @next="getNext"/>
    </template>
  </div>
</template>
